...
% It is different from the previous function since it uses the positive part for the
% post-synaptic activities in Wgs and Wns, and the positive part in the 
% pre-synaptic activity in Wgc and Wnc
        ...
        dop_phasic = 0;
                ...
                if k>=k_reward+klatency && k<=k_reward+klatency+kduration   %time interval of dopamine change
                    ...
                    elseif r==-1   %punishment
                        delta_Dop = -gain_drop_dop*Dop_tonic;%-0.5
                    end
